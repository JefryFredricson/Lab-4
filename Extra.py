...
items = dict([('r', [25, 3]), ('p', [15, 2]), ('a', [15, 2]), ('m', [20, 2]), ('i', [5, 1]), ('k', [15, 1]), ('x', [20, 3]), ('t', [25, 1]), ('f', [15, 1]), ('c', [20, 2]), ('s', [20, 2])])
...
def recurs(size_left, i, points, items_taken):
    ...
    if i == 11 or size_left == 0:
        ...
        if size_left >= items[name_items[i]][1]:
            recurs(size_left - items[name_items[i]][1], i + 1, points + 2*items[name_items[i]][0], items_taken + [name_items[i]])
